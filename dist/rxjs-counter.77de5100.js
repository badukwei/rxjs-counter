...
(0, rxjs_1.fromEvent)(startButton, 'click').subscribe(function () {
  counter$ = new rxjs_1.Subject();
  counter = 0;
  statusLabel.innerHTML = 'status: counting';
  // counts
  counter$.subscribe(function (data) {
    currentCounterLabel.innerHTML = "count: ".concat(data);
  });
  // event counts
  ...
  counter$.subscribe(function (data) {
    evenCounterLabel.innerHTML = "even count: ".concat(data);
  });
  // status 
  counter$.subscribe({
    next: function next() {},
    error: function error(message) {
      statusLabel.innerHTML = "status: error, error message ".concat(message);
    },
...
// counting event
(0, rxjs_1.fromEvent)(countButton, 'click').subscribe(function () {
  counter$.next(counter++);
});
// error event
(0, rxjs_1.fromEvent)(errorButton, 'click').subscribe(function () {
  var reason = prompt('error message');
  counter$.error(reason || 'error');
});
// complete event
(0, rxjs_1.fromEvent)(completeButton, 'click').subscribe(function () {
  counter$.complete();
});
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"../../../../AppData/Roaming/nvm/v14.20.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../AppData/Roaming/nvm/v14.20.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/rxjs-counter.77de5100.js.map